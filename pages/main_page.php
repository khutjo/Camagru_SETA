    ...
    <div class="pic_holder_div">
        ...
        <div class="comment_box">
            <form method="post">
                ...
                <input style="margin: -20px 600px; width: 70px; height: 20px;" type="submit" name="submit_comment"
                    value="comment">
                ...
                <p style="color: white; margin: -50px 700px;">
                    <?php echo $pictures_lineup->pic[$_SESSION['gallary']]["dislikes"];?></p>
                <p style="color: white; margin: -50px 700px;">
                    <?php echo $pictures_lineup->pic[$_SESSION['gallary']]["likes"];?></p>
            </form>
        </div>
    </div>
