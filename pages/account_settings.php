...
<div style="width: 780; height: 700px; margin:20px auto;">
    <div style="width: 500px; height: 700px; border-radius: 10px; margin: 20px auto; background: rgba(0, 0, 0, 0.489);float: left;">
        <form method="post">
            ...
            <input style="margin: 20px 50px;" type="checkbox" name="notify" value="true" <?php if($my_details->my_account["notify"] == "true"){echo "checked='checked'";}?>>
            <p class="check_box">receive comment notifications by email</p><br>
