...
while ($index < 8){
    ...
    // if ($index == 3){
    //     echo $_SESSION['gallary'];
    //     echo $pictures_lineup->pic[$_SESSION['gallary']][0];
    //     echo $pictures_lineup->pic[$_SESSION['gallary']][1];
    //     echo $pictures_lineup->pic[$_SESSION['gallary']][2];
    //     echo $pictures_lineup->pic[$_SESSION['gallary']][3];}
    $start--;
    $index++;
    if ($start == -1){
