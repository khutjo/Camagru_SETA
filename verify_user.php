...
<div class="form_div">
    <p style="color: white; text-align: center;"><?php if (isset($_SESSION['email']) && $_SESSION['email'] != 'sent') echo"click SEND to send the OTP to $mailler->email_adde"; else {echo "if you did not receive the email click RESEND";}?></p>
<form method="post">
    ...
    <input class="resend_button" type="submit" name="re_send" value="<?php if (isset($_SESSION['email']) && $_SESSION['email'] === 'sent'){ echo"RESEND";} else {echo "SEND";}?>">
</form>
</div>
</div>
