...
class get_my_pictures_from_database extends connection {
    ...
    function user_cmp()
    {
        ...
        {
            // $_SESSION['f_vala'] = $user["ID"];
            // $_SESSION['f_valc'] = $this->my_account['ID'];
            // $_SESSION['f_valv'] = $_POST['email'];
            // $_SESSION['f_valb'] = $user['Email'];
    ...
    function is_val_norm(){
        ...
        $this->user_cmp();
        // $_SESSION['f_val'] = $this->f_val;
        // $_SESSION['l_val'] = $this->l_val;
        // $_SESSION['e_val'] = $this->e_val;
        // $_SESSION['u_val'] = $this->u_val;
